...
\begin{lemma}[Abel]
  \[
    \sum_{n = 0}^\infty A_n \lambda_0^n\ \text{converges},\ |\lambda| < |\lambda_0| \implies
...
\begin{thm}[Liouville]
  \[
    f(\lambda) = \sum_{n = 0}^\infty a_n \lambda^n\ \text{is analytical everywhere},\ 
    \forall \lambda \in \C\ |f(\lambda)| \leq M \implies f \equiv const
  \]
\end{thm}
